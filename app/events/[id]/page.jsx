...
export default function EventDetailPage() {
  ...
  const eventSchema = {
    ...
    offers: event.booths?.length > 0 ? {
      "@type": "Offer",
      price: Math.min(...event.booths.map((b) => b.price)),
      priceCurrency: "IDR",
      availability: "https://schema.org/InStock",
      url: `https://bazzarhub.algaray.biz.id/events/${event.id}`,
    } : undefined,
  };
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                >
                  ...
                  {event.faq && event.faq.length > 0 && (
                    <div className="space-y-4">
                      <h2 className="font-bold text-white text-lg">FAQ</h2>
